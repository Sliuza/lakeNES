...
class Instruction {
  ...
  virtual string getDecodedInstruction() = 0;
  ...
  virtual void setDecodedInstruction(string decodedInstruction) = 0;
};
...
class BaseInstruction : public Instruction {
  ...
  void setDecodedInstruction(string decodedInstruction);
};
